...
class TestData
{
    public function testdata()
    {
        ...
        $dataModel = Rule::with('gejala','penyakit')
            ->orderBy('penyakit_id', 'ASC')
            ->get();
        $i= 0;
        foreach($dataModel as $row){
            $arr[$i]['kode_case'] = $row->penyakit->kode;
            $arr[$i]['nama_case'] = $row->penyakit->name;
            $arr[$i]['kode_rule'] = $row->gejala->kode;
            $arr[$i]['nama_rule'] = $row->gejala->name;
            $arr[$i]['nilai_mb'] = 0.8;
            $arr[$i]['nilai_md'] = $row->nilai_cf;
            $i++;
        }
...
//        $arr[3]['kode_rule'] = "G01";
//        $arr[3]['nama_rule'] = "Terasa lemas diseluruh tubuh";
////        $arr[7]['nilai_mb'] = 0.65;
//        $arr[3]['nilai_md'] = 0.2;
////
//        $arr[4]['kode_case'] = "P02";
//        $arr[4]['nama_case'] = "Anemia Defisiensi Zat besi";
//        $arr[4]['kode_rule'] = "G02";
//        $arr[4]['nama_rule'] = "Merasakan sakit kepala";
////        $arr[8]['nilai_mb'] = 0.7;
//        $arr[4]['nilai_md'] = 0.2;
//
//        $arr[9]['kode_case'] = "P02";
